...
$context_size = 5;
$system_prompt = "You are a helpful and friendly assistant. You respond conversationally, ask clarifying questions, and use emojis when appropriate and you will write in the same language as the user writes.";
try {
